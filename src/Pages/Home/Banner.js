...
import { FiFacebook, FiLinkedin, FiDownload } from 'react-icons/fi';
import { AiFillGithub } from 'react-icons/ai';

const Banner = () => {
    return (
        <div id='home' className="hero min-h-screen bg-primary py-20">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <div className="bg-base-200 shadow-lg shadow-cyan-500/50 rounded-lg">
                    <img className='brightness-120' src={Person} alt='' />
                </div>
                <div>
                    ...
                    <div className="my-2">
                        <button className="btn leading-10 hover:btn-secondary text-black border-0 bg-base-100 hover:bg-secondary hover:ease-in-out duration-300 hover:text-white shadow-lg shadow-indigo-300/30 hover:-translate-y-1.5 rounded-md"><a href="https://drive.google.com/uc?id=1Gmn7ImCpljH6sksmGvbi7rPB9tfrAcBy&export=download" >
                    ...
                    <div className="flex">
                        ...
                        <div className='bg-base-100 shadow-lg shadow-cyan-500/50 inline-block mt-5 px-3 py-3 text-2xl rounded-full hover:bg-yellow-600 hover:text-white hover:-translate-y-1.5 ease-in-out duration-300'><a target='_blank' href=' https://github.com/prodiproy99'><AiFillGithub /></a></div>
                    </div>
                </div>
            </div>
        </div>
